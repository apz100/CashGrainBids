...
def main():
    ...
    r_corn = compute_posted_bid_from_cashbids_csv(
        csv_path=out_path,   # <-- you already have this variable
        commodity="Corn",
        delivery="Jan 2026",
        ...
        output_csv=posted_dir / "corn_latest.csv",
    )
    print("POSTED CORN BID:", r_corn)
    ...
    r_soy = compute_posted_bid_from_cashbids_csv(
        ...
        output_csv=posted_dir / "soy_latest.csv",
    )
    print("POSTED SOY BID:", r_soy)
